...
<select id="<?php echo esc_attr( $field_id ); ?>" name="<?php echo esc_attr( $name ); ?>[]" multiple="multiple" class="mc-post-search <?php echo esc_attr( $class ); ?>" data-allow_clear="true" data-minimum_input_length="3"

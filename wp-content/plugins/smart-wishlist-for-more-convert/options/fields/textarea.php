...
<div class="d-flex gap-5">
	...
	<?php if ( ! empty( $translatable ) && true === $translatable && defined( 'WPML_ST_VERSION' ) ) : ?>
		...
		?>
		<a href="<?php echo esc_url( $url ); ?>" class="btn-secondary min-pad"  target="_blank" style="text-align:center;display: inline-block;vertical-align: middle;"><span class="dashicons dashicons-translation"></span></a>
	<?php endif; ?>
</div>
<?php if ( isset( $desc ) ) : ?>

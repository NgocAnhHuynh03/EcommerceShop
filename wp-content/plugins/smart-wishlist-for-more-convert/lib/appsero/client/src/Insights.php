...
class Insights {
	...
	public function admin_notice() {
		...
		$optin_url  = add_query_arg( $this->client->slug . '_tracker_optin', 'true', $this->clean_url() );
		$optout_url = add_query_arg( $this->client->slug . '_tracker_optout', 'true', $this->clean_url() );

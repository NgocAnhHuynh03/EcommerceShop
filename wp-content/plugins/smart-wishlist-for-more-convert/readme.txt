=== WooCommerce Wishlist, Back-in-Stock Waitlist,Save for Later, Email Marketing & More!(Free Elementor Wishlist) ===

Contributors: MoreConvert
Tags: woocommerce wishlist, woocommerce Waitlist, woocommerce product wishlist plugin,  Wishlist for woocommerce, out of stock, marketing, back-in-stock, email marketing, save for later, wishlist elementor
...
**Free:** Wishlist, Email Automation, Elementor and **Premium:** Out of Stock Waitlist, Save For Later, Multi Wishlists, Analytics, Email Marketing
...
- One Email Automation: Streamline Sequential email campaigns.
- **Elementor Integration:** Customize with Elementor

📚 **[DOCUMENTATION](https://moreconvert.com/docs/wishlist/?utm_source=wordpressorg&utm_content=documentation)**| 22 ✨ Significant Update in 2023 | ⚡ Swift and Attentive Support Team

**Premium Version:**
- Back-in-Stock Waitlist: Alert when items return.

...
Click here to check it out ➡️ <a href="{product_url}">{product_name}</a>
...
Check it out here ➡️ <a href="{product_url}">{product_name}</a>This is your chance to grab it before it\'s gone again.
...
Ready to grab {product_name} at a discounted price? Click here ➡️ <a href="{product_url}">{product_name}</a>
...
Secure your {coupon_amount} discount with code {coupon_code} before it\'s too late. Click here ➡️ <a href="{product_url}">{product_name}</a>
...
Shop now before it\'s too late! Click here ➡️ <a href="{product_url}">{product_name}</a>
...
The {product_name} is now available at {sale_price}, but you have to act quickly. Grab yours before they\'re all gone! 🏃‍♂️💨
